...
import top.javahouse.session.inteceptor.LoginInterceptor;
...
public class MyWebMvcConfigurer extends WebMvcConfigurationSupport {
    ...
    public void addInterceptors(InterceptorRegistry interceptor) {
        //自定义拦截器 HandlerInterceptor 方法没有生效
        interceptor.addInterceptor(loginInterceptor)
                .addPathPatterns("/**") //      //拦截的api路径
                .excludePathPatterns("/da","/v1")
        ;
